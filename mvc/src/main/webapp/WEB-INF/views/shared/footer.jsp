		...
		<div class="footer-widgets-wrap clearfix">
			<div class="col_half">
				<div class="widget portfolio-widget clearfix">
					<h4>
						About <span>Rooted</span>Technologies
					</h4>
					<p>Rooted Technologies was founded in January of 2014. We are a software development firm with a focus in web development and design.</p>
				</div>
			</div>
